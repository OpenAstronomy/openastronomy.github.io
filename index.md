...
You can also get involved by joining our chat using either: Matrix
([#openastronomy:matrix.org](https://riot.im/app/#/room/#openastronomy:matrix.org)),
IRC (<a href="{{ site.irc_freenode }}#{{site.irc_channel }}">#openastronomy on
freenode.net</a>) or [gitter](https://gitter.im/OpenAstronomy/Lobby)  which
regularly has a number of people in it, if you want to pop in for an astronomy
