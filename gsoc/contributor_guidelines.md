...
OpenAstronomy mailing list ([how to use Google Groups](https://support.google.com/groups/answer/1046523?hl=en)),
join the [GSoC contributors mailing list](mailto:openastronomy-gsoc-contributors@googlegroups.com),
chat with us in the Matrix channel ([how to connect to matrix](https://element.io/user-guide)) and if required contact the mentors to know
